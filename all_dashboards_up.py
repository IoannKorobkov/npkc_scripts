...
DAYS_АИ_ЮЗИНГ         = 10    # ai_using_up:           ai_using_studies (Target CH)
...
if _mods['svo_eris_llo']: _mods['svo_eris_llo'].DAYS_TO_SYNC = DAYS_SVO_ERIS_LLO 
...
def main():
    ...
    if m['svo_eris_llo']:
        extract_results['svo_eris_llo / svo_eris_llo_examinations'] = \
            _run_task("svo_eris_llo [extract]", lambda: m['svo_eris_llo'].extract_phase())
    ...
    if m['svo_eris_llo'] and extract_results.get('svo_eris_llo / svo_eris_llo_examinations'):
        load_results['svo_eris_llo / svo_eris_llo_examinations'] = \
            _run_task("svo_eris_llo [load]", lambda: m['svo_eris_llo'].load_phase())
    ...
    if m['describe_time_daily'] and extract_results.get('describe_time_daily / describe_time_daily'):
        load_results['describe_time_daily / describe_time_daily'] = \
            _run_task("describe_time_daily [load]", lambda: m['describe_time_daily'].load_phase())
